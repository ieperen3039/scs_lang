...
constant_def            : keyword_const_ type_ref identifier ':' statement;
...
statement_separator     : ';';
expression_             : static_function_call | implicit_par_lambda | explicit_par_lambda | method_reference;
...
mutator_                : method_call | static_function_call | mutator_cast | mutator_assign;
operator                : OPERATOR;
