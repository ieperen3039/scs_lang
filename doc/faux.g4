...
function_expression_    : method_call | external_method_call | mutator_cast | mutator_assign | implicit_par_lambda | explicit_par_lambda | (operator function_expression_);
